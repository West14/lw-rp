...
function renderTabList()
	...
	for i,player in ipairs(players) do
		...
		dxDrawText(getElementData(player, 'id'), (screenW * 0.3476)*i, screenH * 0.2410, screenW * 0.3631, screenH * 0.2533, tocolor(0, 0, 0, 255), 1.00, "default", "left", "top", false, false, false, false, false)
