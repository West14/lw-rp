...
function dxDrawLogo()
    if isLogged(lp) then
        dxDrawImage(screenW * (1245/sX), screenH * (15/sY), 68, 47, "Images/auth-logo.png", 0, 0, 0, tocolor(255, 255, 255, 255))
        dxDrawText("LYNCHWOOD", screenW * 0.9056, screenH * 0.0333, screenW * 0.9931, screenH * 0.0489, Colors["general"], 1.00, font_montmediumXX, "center")
        dxDrawText("ROLEPLAY", screenW * 0.9056, screenH * 0.0489, screenW * 0.9931, screenH * 0.0644, Colors["general"], 1.00, font_montregularB, "center")
